        ...
        <ul class="nav flex-column justify-content-center ">
            <li class="m-b-20">
                <a class="nav-link" href="#">
                    <img src="<?= PORTAL ?>assets/img/logo.png" class="lena-normal-logo m-auto" width="150" alt="">
                    <img src="<?= PORTAL ?>assets/img/logo.png" class="lena-small-logo m-auto" width="150" alt="">
                </a>
            </li>
            <?php
