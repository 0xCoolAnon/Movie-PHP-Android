<div class="card">
  <div class="card-header">
    <span class="fa fa-list"></span> Status Dokumen
  ...
  <div class="card-body">
    ...
    <div class="row justify-content-between text-center">
      <div class="col-4">
        Kos anggaran: <br>
        <input type="text" class="form-control" placeholder="Masukkan Nilai" name="kos_anggaran" value="<?= $d->d_anggaran_kos ?>" disabled>
      </div>
      ...
      <div class="col-4">
        Tempoh anggaran : <br>
        <input type="text" class="form-control" placeholder="Masukkan Tempoh" name="tempoh_anggaran" value="<?= $d->d_anggaran_masa ?>" disabled>
      </div>
    </div>
    </form> <br>
