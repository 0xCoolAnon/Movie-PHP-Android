...
<div class="card">
    <div class="card-header">
        ...
        Buang Pengguna
                ...
                <a href="<?= PORTAL ?>pengguna/delete/<?= $user[0]->u_id ?>" class="btn btn-sm btn-danger">
                                ...
                                <div class="card-body"><div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4 mx-auto">
                                            <img src="<?= PORTAL ?>assets/images/profile/<?= $u->u_picture ?>" class="img img-responsive" width="50%" alt="Gambar Tidak Dijumpai" /><br />
                                        </div>
                                        <br>
